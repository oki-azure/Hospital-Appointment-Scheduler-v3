            ...
            <div className='flex items-center gap-4'>
                {
                    ...
                    ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                        <img className='w-8 rounded-full'src={assets.profile_pic} alt="" onClick={() => setShowProfileDropdown(prev => !prev)} />
                        <img className='w-2.5'src={assets.dropdown_icon} alt="" onClick={() => setShowProfileDropdown(prev => !prev)} />
